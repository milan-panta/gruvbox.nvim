...
return {
	normal = {
		...
		b = { bg = bg_base, fg = p.blue_lite, gui = "bold" },
		c = sec,
	},
	insert = {
		a = { bg = bg_base, fg = p.green_lite, gui = "bold" },
		b = { bg = bg_base, fg = p.green_lite, gui = "bold" },
		c = sec,
	},
	visual = {
		a = { bg = bg_base, fg = p.yellow_lite, gui = "bold" },
		b = { bg = bg_base, fg = p.yellow_lite, gui = "bold" },
		c = sec,
	},
	replace = {
		a = { bg = bg_base, fg = p.orange_lite, gui = "bold" },
		b = { bg = bg_base, fg = p.orange_lite, gui = "bold" },
		c = sec,
	},
	command = {
		a = { bg = bg_base, fg = p.purple_lite, gui = "bold" },
		b = { bg = bg_base, fg = p.purple_lite, gui = "bold" },
		c = sec,
	},
	inactive = {
