...
local function set_highlights()
	...
	local default_highlights = {
		...
		NormalNC = {
			fg = palette.fg2,
			bg = config.options.dim_inactive_windows and palette.bg_second or palette.bg_main,
		},
		...
		RenderMarkdownH1Bg = { fg = palette.red_lite, bg = palette.none },
		RenderMarkdownH2Bg = { fg = palette.yellow_lite, bg = palette.none },
		RenderMarkdownH3Bg = { fg = palette.green_lite, bg = palette.none },
		RenderMarkdownH4Bg = { fg = palette.aqua_lite, bg = palette.none },
		RenderMarkdownH5Bg = { fg = palette.blue_lite, bg = palette.none },
		RenderMarkdownH6Bg = { fg = palette.purple_lite, bg = palette.none },
